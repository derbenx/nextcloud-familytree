...
// Translated by FasteryXD
["Deutsch","Stammbaumname:", "Vorname:","Nachname:","Geschlecht:","Geburtstag:","Todestag:","Weitere Infos:","Verwandschaft:","Auswahl:","weiblich","männlich","divers","kein Geschlecht","Auswählen","verheiratet mit ", "Eltern von ","Geschwister von ","adoptiert von ","geschieden von ","zusammenlebend mit ","Hintergrundfarbe","Mehrfachauswahl","Sprachauswahl:","ID-Paar links auswählen und Verwandschaft eintragen.","schwarz","weiß","rot","grün","blau","orange","gelb","grau","Die Verwandschaft zwischen "," und ",". Du kannst die Auswahl mit dem Verwandschafts-Auswahlfeld links ändern.","Neue Person","Person aktualisieren","Person löschen","Vollbildmodus","Normal","Neuer Stammbaum","Stammbaum speichern","Stammbaum laden","Stammbaum zentrieren","verstecken","anzeigen","unklar","Für den Fall, dass der Stammbaum geleert werden soll:","Person kann nicht ohne Verwandschaftsverhältnis angelegt werden. Verwandschaftsgrad auswählen!","Die Person mit id:0 kann nicht gelöscht werden","Stammbaumnamen vergeben!","GED importieren","Dieses Feature übernimmt nicht alle Daten aus einer GED-Datei. Die Daten müssen manuell angepasst werden.","Adoptiert: ","Getauft: ","Eingeäschert: ","Taufe: ","Beerdigung: ","Geburt: ","Tod: ","Notiz: ","adoptiert.","Titel: ","Hilfe"]
...
help=[
 ...
 `  Ansicht schwenken: WADS-Tasten
  
  Standardmodus: 
   Klicken, um eine Person auszuwählen
   Ziehen, um entweder eine Person zu verschieben oder die Ansicht schwenken.
  
  Mehrfachauswahl:
   Klicken, um Personen aus-/abzuwählen
   Ansicht verschieben, um die ausgewählten Personen zu bewegen
   
  ID-Zeilen-Box:
   Klicken, um die erste ID zu finden
   Doppelklicken, um die zweite ID zu finden`
